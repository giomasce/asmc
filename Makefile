...
initrd-asmg.ar: main.g test.c utils.g malloc.g vector.g map.g preproc.g END
	-rm initrd-asmg.ar
	ar rcs initrd-asmg.ar main.g test.c utils.g malloc.g vector.g map.g preproc.g END
