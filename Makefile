...
initrd-asmg.ar: main.g test.c first.h other.h utils.g malloc.g vector.g map.g preproc.g END
	-rm initrd-asmg.ar
	ar rcs initrd-asmg.ar main.g test.c first.h other.h utils.g malloc.g vector.g map.g preproc.g END
